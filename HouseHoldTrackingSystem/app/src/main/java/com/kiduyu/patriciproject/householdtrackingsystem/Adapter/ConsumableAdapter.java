...
//        holder.halfGauge.setValue(Double.parseDouble(consumable.getItemremaining()));
        ...
        if (Integer.parseInt(consumable.getItemremaining())<=3) {
            holder.cardView.setCardBackgroundColor(Color.RED);
            holder.linearLayout.setBackgroundColor(Color.RED);
        }
        else if (Integer.parseInt(consumable.getItemremaining())<=10) {
        ...
        if (Integer.parseInt(consumable.getItemremaining())<14) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            cardView =  view.findViewById(R.id.CardViewConsumableItem);
            linearLayout = view.findViewById(R.id.LinerLayoutConsumableItem);
