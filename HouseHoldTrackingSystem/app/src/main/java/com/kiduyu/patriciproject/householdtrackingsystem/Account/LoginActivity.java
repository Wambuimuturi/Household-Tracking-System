...
import com.kiduyu.patriciproject.householdtrackingsystem.Admin.AdminLoginActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void AllowAccessToAccount(final String phone, final String password) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                //check if seller is registered but not approved by admin
                if (parentDbName.equals("Delivery") && dataSnapshot.child("Approve Delivery").child(phone).exists()){
                    FancyToast.makeText(LoginActivity.this,"You can't access account before admin approves you",FancyToast.LENGTH_LONG,FancyToast.WARNING,false).show();
                    loadingBar.dismiss();
                    return;
                }
